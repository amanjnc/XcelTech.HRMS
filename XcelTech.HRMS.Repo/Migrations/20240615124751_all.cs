        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentDuration = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "LeavePaymentDetails",
                columns: table => new
                {
                    LeavePaymentDetailId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LeaveTypeId = table.Column<int>(type: "integer", nullable: false),
                    DaysFrom = table.Column<int>(type: "integer", nullable: false),
                    DaysTo = table.Column<int>(type: "integer", nullable: false),
                    PaymentPercentage = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeavePaymentDetails", x => x.LeavePaymentDetailId);
                    table.ForeignKey(
                        name: "FK_LeavePaymentDetails_LeaveTypes_LeaveTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeFiles", x => x.EmployeeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatIDone = table.Column<string>(type: "text", nullable: false),
                    FuturePlans = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeavePaymentDetails_LeaveTypeId",
                table: "LeavePaymentDetails",
                column: "LeaveTypeId");
